...
DER, Microsoft, OpenSSH, Dropbear, SSH RSA1, GPG 2.2 .key, GPG 2.3 .key, GPG
exported key). The command-line interface is compatible with of
`openssl genrsa', `openssl rsa', `openssl genpkey' and `openssl pkey'.
